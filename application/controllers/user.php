...
class User extends AdminController
{
	...
	public function index()
	{
		...
		$crud->columns('nama', 'u_name', 'jabatan_id', 'notelp', 'level');
		$crud->fields('nama', 'u_name', 'jabatan_id', 'notelp', 'level', 'pass_word');



		$crud->display_as('u_name', 'Username');
		$crud->display_as('notelp', 'Nomor Telepon');
		$crud->display_as('jabatan_id', 'Jabatan');
		$crud->display_as('pass_word', 'Password');

		$crud->required_fields('u_name', 'level');
